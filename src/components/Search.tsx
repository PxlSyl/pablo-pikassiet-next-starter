...
import { FaRegFolder, FaRegUserCircle, FaSearch } from 'react-icons/fa/index.js'
            ...
            searchResults?.map(({ item }, index) => (
              <div className="mb-12 md:col-6 lg:col-4" key={`search-${index}`}>
                <div className="bg-body dark:bg-darkmode-body">
                  ...
                  <h4 className="mb-3">
                    <Link href={`/${blog_folder}/${item.slug}`}>{item.frontmatter.title}</Link>
                  </h4>
                  <ul className="mb-4">
                    ...
                    <li className="mr-4 inline-block">
                      ...
                      {item.frontmatter.categories.map((category: string, index: number) => (
                        <a href={`/categories/${slugify(category)}`} key={category}>
                          {humanize(category)}
                  ...
                  <p className="mb-6">{plainify(item.content?.slice(0, Number(summary_length)))}</p>
                  <a
